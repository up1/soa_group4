...
public class AccountRepository {
    ...
    public AccountToMatching accountToMatching(long account_id){
        ...
        accountToMatching.setAccount_age(age);
        return accountToMatching;
    }

    @Transactional
    public String editProfile(String email,String password,String name,String lastname,long birthday,String sex,String sextaste,float lat,float lon,String location,String des,long id,String search_sex,String search_sextaste,int min_age,int max_age,float distance){
        try {
            String sql = "UPDATE ACCOUNT SET account_email = ?,account_password = ?,account_name = ?,account_lastname = ?,account_age = ?, account_birthday = ?, account_sexual_taste = ?,account_latitude = ?,account_longtitude = ?,account_location = ?,account_descriptions = ? WHERE account_id = ?";
            ...
            this.jdbcTemplate.update(sql,email,password,name,lastname,birthday,sex,sextaste,lat,lon,location,des,id);
